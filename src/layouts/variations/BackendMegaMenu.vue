      ...
      <nav class="d-none d-lg-flex align-items-center space-x-2">
        ...
        <div class="dropdown">
          <button
            ...
            aria-expanded="false"
          >
            <i class="fa fa-globe-americas opacity-50 me-2" />
            <span>Websites</span>
            <i class="fa fa-fw fa-angle-down opacity-50 ms-2" />
          </button>
          <div
        ...
        <div class="dropdown">
          <button
            ...
            aria-expanded="false"
          >
            <i class="fa fa-box opacity-50 me-2" />
            <span>Apps</span>
            <i class="fa fa-fw fa-angle-down opacity-50 ms-2" />
          </button>
          <div
        ...
        <div class="dropdown">
          <button
            ...
            aria-expanded="false"
          >
            <i class="fa fa-cog opacity-50 me-2" />
            <span>Settings</span>
            <i class="fa fa-fw fa-angle-down opacity-50 ms-2" />
          </button>
          <div
